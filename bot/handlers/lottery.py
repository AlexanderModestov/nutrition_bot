...
PRIZES = [
    ...
    Prize(
        ...
        image="prize_5.jpg",
        caption=(
            "📋 <b>Чек-лист '10 шагов к здоровому питанию'</b>\n\n"
            "Начните менять свою жизнь уже сегодня с помощью простых и понятных шагов!"
        ),
        type=PrizeType.FILE,
        payload="FILE_ID_CHECKLIST"  # Замените на реальный file_id
    ),
